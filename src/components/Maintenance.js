...
const Maintenance = () => {
  ...
  const loadMaintenance = async () => {
    try {
      ...
      // Il backend restituisce { expenses: { ordinaria: [...], straordinaria: [...] }, notes: { ordinaria: '', straordinaria: '' } }
      if (data && data.expenses) {
        ...
        Object.keys(maintenanceTypes).forEach(key => {
          if (data.expenses[key] && Array.isArray(data.expenses[key])) {
            converted[key] = data.expenses[key].map(expense => ({
              id: expense.id,
            ...
            return (
              <div key={type} className="maintenance-item">
                <div className="maintenance-left">
                  ...
                  <div className="maintenance-notes-section">
                    <button
                      type="button"
                      className="toggle-notes-btn"
                      onClick={() => setShowNotes({ ...showNotes, [type]: !showNotes[type] })}
